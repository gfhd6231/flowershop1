...
class App {
    ...
    _setupUI() {
        ...
        const ringColors = ["#D4AF37", "#8A8D8F", "#E6C7C2", "#6ab04c" ,"#ffffff"];
    ...
    _setupModel() {
        new RGBELoader()
            .setPath("./data/")
            .load("industrial_sunset_puresky_4k.hdr", texture => {
                ...
                loader.load("./data/flow.glb", gltf => {
